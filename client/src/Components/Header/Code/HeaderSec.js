...
function handleLogin() {
  if (isLoggedIn === null)
    window.location.href = "http://localhost:3000/loginsignup";
  else window.location.href = "http://localhost:3000/sell";
}
const Header = () => {
  return (
    <nav className="bg-gray-800 px-4 py-2 flex lg:flex-row items-center flex-shrink-0">
      ...
      <div className="flex my-3 my-0">
        ...
        <a href="#" onClick={handleLogin}>
          <button
            className="bg-transparent hover:bg-white text-white hover:text-gray-900 py-1 px-3 rounded border border-solid border-white mr-2 hidden lg:block"
            onClick={handleLogin}
          >
            &#43; SELL
          </button>
        </a>
        <a href="#" onClick={handleOp}>
          <button
